    ...
    : EditorWindow
{
    ...
    [SerializeField]
    static float cameraMoveSpeed = .5f; // default was 10
    [SerializeField]
    static float cameraMoveSpeedCtrl = .25f; // default was 1
    ...
    public void OnGUI()
    {
        ...
        cameraMoveSpeed = EditorGUILayout.Slider(cameraMoveSpeed, 0.0f, 100.0f);
